...
<?php function drawFooter(Session $session) { ?>
    ...
    <footer>
      ...
      <?php 
        if ($session->isLoggedIn()) drawLogoutFooter($session);

        else drawLoginFooter($session);
      ?>
...
<?php function drawLogoutFooter(Session $session) { ?>
...
<?php function drawLoginFooter(Session $session) { ?>
