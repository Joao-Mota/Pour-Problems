...
INSERT INTO Ticket
VALUES (1, 'Problem with delivery', 'Delivery boy dropped the box', '10/05/23 10:00', 'Delivery', 2);
INSERT INTO Ticket
VALUES (2, 'Could not access the website', 'I can not access the website', '10/11/20 10:00', 'General', 3);
INSERT INTO Ticket
VALUES (3, 'Problem with payment', 'I can not pay', '20/05/23 14:23', 'Payment', 2);
INSERT INTO Ticket
VALUES (4, 'Problem with packaging', 'The box is damaged', '20/04/23 11:25', 'Packaging', 2);
INSERT INTO Ticket
VALUES (5, 'Doubt', 'I have a doubt, which one should I choose?', '11/03/23 18:54', 'General', 3);
INSERT INTO Ticket
VALUES (6, 'Changing Address', 'I gave the wrong address while ordering and want to change it', '20/05/23 18:55', 'Delivery', 1);
INSERT INTO Ticket
VALUES (7, 'VIP', 'I am a VIP and want to know if I can get a discount', '17/05/23 15:51', 'General', 2);
INSERT INTO Ticket
VALUES (8, 'Doubt about causing hangovers', 'I have a doubt, which is better for avoiding hangovers?', '28/02/23 11:00', 'General', 3);
INSERT INTO Ticket
VALUES (9, 'How can I tell if my wine is corked?', 'After opening and smelling the wine, I think it is corked, how can I be sure?', '18/05/23 11:00', 'Packaging', 2);
INSERT INTO Ticket
VALUES (10, 'Prices', 'Is there anyway I could buy larger quantities at a smaller price?', '20/05/23 13:25', 'General', 2);
...
VALUES (1, '10/05/23 10:00 - Ticket was created', 1);
INSERT INTO Ticket_History
VALUES (2, '10/05/23 10:02 - Assigned to AgentMota', 1);
INSERT INTO Ticket_History
VALUES (3, '10/11/20 10:00 - Ticket was created', 2);
INSERT INTO Ticket_History
VALUES (4, '10/11/20 10:01 - Assigned to AgentLandolt', 2);
INSERT INTO Ticket_History
VALUES (5, '10/11/20 10:33 - Changed status to Closed', 2);
INSERT INTO Ticket_History
VALUES (6, '20/05/23 14:23 - Ticket was created', 3);
INSERT INTO Ticket_History
VALUES (22, '20/05/23 14:25 - Assigned to AgentLima', 3);
INSERT INTO Ticket_History
VALUES (7, '20/04/23 11:25 - Ticket was created', 4);
INSERT INTO Ticket_History
VALUES (8, '20/04/23 11:28 - Assigned to AgentCoelho', 4);
INSERT INTO Ticket_History
VALUES (9, '11/03/23 18:54 - Ticket was created', 5);
INSERT INTO Ticket_History
VALUES (10, '11/03/23 18:55 - Assigned to agent1', 5);
INSERT INTO Ticket_History
VALUES (11, '12/03/23 8:38 - Changed status to Closed', 5);
INSERT INTO Ticket_History
VALUES (12, '20/05/23 18:55 - Ticket was created', 6);
INSERT INTO Ticket_History
VALUES (13, '17/05/23 15:51 - Ticket was created', 7);
INSERT INTO Ticket_History
VALUES (14, '17/05/23 15:53 - Assigned to agent1', 7);
INSERT INTO Ticket_History
VALUES (15, '28/02/23 11:00 - Ticket was created', 8);
INSERT INTO Ticket_History
VALUES (16, '28/02/23 11:02 - Assigned to AgentMota', 8);
INSERT INTO Ticket_History
VALUES (17, '28/02/23 11:05 - Changed status to closed', 8);
INSERT INTO Ticket_History
VALUES (18, '18/05/23 11:00 - Ticket was created', 9);
INSERT INTO Ticket_History
VALUES (21, '18/05/23 11:02 - Assigned to AgentCoelho', 9);
INSERT INTO Ticket_History
VALUES (19, '20/05/23 13:25 - Ticket was created', 10);
INSERT INTO Ticket_History
VALUES (20, '20/05/23 13:26 - Assigned to AgentLandolt', 10);

-- Insert de Messages
--Id, text, datetime, user_id, ticket_id
INSERT INTO Message
VALUES (1, 'Hello there, I am your assigned agent, how may I help you?', '10/05/23 10:03', 5, 1);
INSERT INTO Message
VALUES (2, 'Saw the delivery boy drop the box when he arrived, attachment contains a pic of the result.', '10/05/23 10:15', 12, 1);
INSERT INTO Message
VALUES (3, 'Thank you for your feedback, we will handle it from here.', '10/05/23 10:23', 5, 1);
INSERT INTO Message
VALUES (4, 'Hello there, I am your assigned agent, how may I help you?', '10/11/23 10:05', 6, 2);
INSERT INTO Message
VALUES (5, 'I can not access the website', '10/11/20 10:18', 13, 2);
INSERT INTO Message
VALUES (6, 'Thank you for your feedback, we will handle it from here.', '10/11/20 10:23', 6, 2);
INSERT INTO Message
VALUES (7, 'It has been fixed', '10/11/20 10:33', 6, 2);
INSERT INTO Message
VALUES (8, 'Hello there, I am your assigned agent, can you provide more info about the box?', '20/05/23 14:25', 7, 4);
INSERT INTO Message
VALUES (9, 'The box is heavily damaged, it looks like it has been rained on', '20/05/23 14:27', 15, 4);
INSERT INTO Message
VALUES (10, 'Thank you for your feedback, we will handle it from here.', '20/05/23 14:30', 7, 4);
INSERT INTO Message
VALUES (11, 'Hello there, the best depends on your wine preferences, can you tell me a bit about them?', '11/03/23 18:56', 4, 5);
INSERT INTO Message
VALUES (12, 'I like red wine, but I am open to trying new things', '12/03/23 01:35', 16, 5);
INSERT INTO Message
VALUES (13, 'I recommend Alvarinho, then.', '12/03/23 08:37', 4, 5);
INSERT INTO Message
VALUES (14, 'Hello there, I will take a look at your level of fame and get back to you', '17/05/23 18:56', 4, 7);
INSERT INTO Message
VALUES (15, 'Make it fast, I am very important.', '18/05/23 14:31', 18, 7);
INSERT INTO Message
VALUES (16, 'Hello there, I would definitely recommend the "Branco Grande Escolha" if you do not want to drink a wine with too much alcohol', '28/02/23 11:05', 5, 8);
INSERT INTO Message
VALUES (17, 'Hello there, I will ask my superiors and get back to you', '15/05/23 13:25', 6, 10);
INSERT INTO Message
VALUES (18, 'OK, thank you', '15/05/23 18:25', 11, 10);
